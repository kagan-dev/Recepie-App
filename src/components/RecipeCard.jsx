...
const RecipeCard = ({ recipe, bg, badge }) => {
  ...
  return (
    ...
    >
      <a
        href={`https://youtube.com/results?search_query=${recipe.label} recipe`}
        target="_blank"
      ...
      >
				...
				/>
        <div className="absolute bottom-2 left-2 bg-white rounded-full p1 cursor-pointer flex items-center gap-1 text-sm">
